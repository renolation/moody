...
abstract class ActivityRemoteDataSource {
  Future<List<ActivityEntryModel>> getActivities({String? userId});
  Future<List<ActivityEntryModel>> getActivitiesByDate(DateTime date, {String? userId});
...
class ActivityRemoteDataSourceImpl implements ActivityRemoteDataSource {
  ...
  @override
  Future<List<ActivityEntryModel>> getActivities({String? userId}) async {
